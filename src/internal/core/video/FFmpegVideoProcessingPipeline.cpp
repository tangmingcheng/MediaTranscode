...
FFmpegVideoProcessingPipeline::~FFmpegVideoProcessingPipeline()
{
    reset();
}

void FFmpegVideoProcessingPipeline::reset()
{
    m_filterStage.reset();
...
Status FFmpegVideoProcessingPipeline::initialize(const Config& config)
{
    reset();

    if (!config.transcodeConfig) {
        return Status::failure(ErrorInfo::invalidArgument(
            "FFmpegVideoProcessingPipeline initialize failed: transcodeConfig is null"));
    }
...
Status FFmpegVideoProcessingPipeline::initializeTimestampStage(
...
Status FFmpegVideoProcessingPipeline::openDecoder()
{
...
Status FFmpegVideoProcessingPipeline::collectVideoInputMetadata()
{
...
Status FFmpegVideoProcessingPipeline::openEncoder()
{
...
Status FFmpegVideoProcessingPipeline::initializeFrameRoutingStrategy()
{
...
Status FFmpegVideoProcessingPipeline::initializeHardwareTransferStage()
{
...
Status FFmpegVideoProcessingPipeline::initializeFrameRateStage()
{
...
Status FFmpegVideoProcessingPipeline::initializeFilterStage()
{
...
Status FFmpegVideoProcessingPipeline::processPacket(
    AVPacket* packet,
...
Status FFmpegVideoProcessingPipeline::flushDecoder(
    const PacketWrittenCallback& onPacketWritten)
{
...
Status FFmpegVideoProcessingPipeline::drainDecoder(
    const PacketWrittenCallback& onPacketWritten)
{
    while (true) {
...
Status FFmpegVideoProcessingPipeline::processDecodedFrame(
    const PacketWrittenCallback& onPacketWritten)
{
...
Status FFmpegVideoProcessingPipeline::processHardwareFrameZeroCopy(
    const PacketWrittenCallback& onPacketWritten)
{
    std::string error;
...
Status FFmpegVideoProcessingPipeline::processFrameThroughSoftwareFilter(
    AVFrame* frame,
    const PacketWrittenCallback& onPacketWritten)
{
    std::string error;
...
Status FFmpegVideoProcessingPipeline::drainFrameRateStage(
    bool hardwareFrame,
    const PacketWrittenCallback& onPacketWritten)
{
    while (true) {
...
Status FFmpegVideoProcessingPipeline::sendFrameRateOutputToFilter(
    AVFrame* frame,
    bool hardwareFrame,
    const PacketWrittenCallback& onPacketWritten)
{
...
Status FFmpegVideoProcessingPipeline::drainFilterStage(
    const PacketWrittenCallback& onPacketWritten)
{
    while (true) {
        std::string error;
...
AVCodecContext* FFmpegVideoProcessingPipeline::encoderContext() const
{
    return m_encoderStage.context();
}

bool FFmpegVideoProcessingPipeline::isInitialized() const
{
...
int64_t FFmpegVideoProcessingPipeline::decodedFrameCount() const
{
