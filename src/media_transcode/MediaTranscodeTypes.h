...
// Internal video codec description. Public callers use OutputVideoCodec from MediaTranscode.h.
...
// Internal rate-control mode. Public callers use VideoRcMode from MediaTranscode.h.
