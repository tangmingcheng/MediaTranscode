...
- Direct FFmpeg-to-realtime-CLI RTP run: completed with 3,017 encoded packets pushed, `workerErrors=0`, and preserved the first worker failure path for diagnostic runs.
