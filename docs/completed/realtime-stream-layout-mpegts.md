...
| `out\build\x64-debug\media_transcode_graph_transcode_cli.exe --mode realtime-rtp --input-type mpegts-udp --input-layout mpegts --output-layout mpegts --input "udp://127.0.0.1:15100?fifo_size=1000000&overrun_nonfatal=1" --output "udp://127.0.0.1:15102" --open-timeout-ms 5000 --read-timeout-ms 5000 --analyze-duration-us 500000 --probe-size 524288 --video --no-audio --metadata-queue 1 --packet-queue 256 --frame-queue 128 --mux-queue 256 --video-codec h264 --rc auto --duration 3` | Success. CLI exited with code 0 from the repository root, planned and ran `MpegTsUdp + MuxedTransportStream + MuxedTransportStream`; runtime registered `RealtimeInput`, `FileOutput`, and `FileMux`, then stopped after duration. |
| `media_transcode_graph_transcode_cli.exe --mode realtime-rtp --input-type mpegts-udp --input-layout mpegts --output-layout mpegts --input "udp://127.0.0.1:15100?fifo_size=1000000&overrun_nonfatal=1" --output "udp://127.0.0.1:15102" --open-timeout-ms 5000 --read-timeout-ms 5000 --analyze-duration-us 500000 --probe-size 524288 --video --no-audio --metadata-queue 1 --packet-queue 256 --frame-queue 128 --mux-queue 256 --video-codec h264 --rc auto --duration 3` | Success. Equivalent command when the current directory is `D:\Code\MyCode\MediaTranscode\out\build\x64-debug`. |
