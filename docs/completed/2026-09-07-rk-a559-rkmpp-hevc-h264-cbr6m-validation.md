...
run26 从 `2026-09-07T12:16:03.307432463+08:00` 开始，源在 `12:20:12.692928887+08:00` 自然结束，持续 249.386 秒。CLI PID `3809859`，源 PID `3809862`，目标机输入/输出抓包 PID `3809840/3809841`，脚本 PID `3809600`；Windows dumpcap/VLC PID `23028/9932`。
...
- 输出 PTS 共 `6204` 个，媒体时长 `248.12` 秒，40 ms 步长连续，PTS/PCR 到达漂移末值约 `-0.199 ms`。`h264_rkmpp` 硬解全部 6204 帧并以 0 退出。
